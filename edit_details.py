...
class edit_info:
    def __init__(self, username):
        ...
        cursor = conn.cursor()
        self.pi = cursor.execute(f"""SELECT * FROM me_{self.user}""")
        ...
        self.head = Label(self.edit_window, text='Edit Profile', bg='white', fg='#B8CE00', font=('Cambria', 22, 'bold'))
        self.head.pack()
        ...
        self.notes = LabelFrame(self.edit_window, text='Personal Notes', width=350, height=200, bd=5, bg='white', fg='#8C118D', font=('Times New Roman', 14, 'bold'))
    ...
    def choose_picture(self):
        ...
        if self.filename != None:
            ...
            img_cropped.save('circle_photos/me.png')

            self.img = Image.open('circle_photos/me.png') #pic
    ...
    def save_to_database(self):
        ...
        self.update_to_db = cursor.execute(f"""UPDATE me_{self.user} SET NAME = '{self.user_name}', pic='{self.photo}',
        EMAIL = '{self.user_email}', ADDRESS = '{self.user_address}', PHONE1 = '{self.pno1}', 
        PHONE2 = '{self.pno2}', PHONE3 = '{self.pno3}', notes = '{self.pnotes}'""")
